...
export const AppMenu = GObject.registerClass(
class AppMenu extends PopupMenu.PopupSubMenuMenuItem {
    /**
    ...
    constructor(params = {}) {
        ...
        this.menu.addMenuItem(this._openWindowsHeader);
        ...
        this._newWindowItem = this.menu.addAction(_('New Window'), () => {
            this._animateLaunch();
        ...
        this._onGpuMenuItem = this.menu.addAction('', () => {
            this._animateLaunch();
        ...
        this._toggleFavoriteItem = this.menu.addAction('', () => {
        ...
        this._detailsItem = this.menu.addAction(_('App Details'), async () => {
        ...
        this._quitItem =
            this.menu.addAction(_('Quit'), () => this._app.request_quit());
        ...
        this._parentalControlsManager.connectObject(
            'app-filter-changed', () => this._updateFavoriteItem(), this);

        this._appFavorites.connectObject(
            'changed', () => this._updateFavoriteItem(), this);
