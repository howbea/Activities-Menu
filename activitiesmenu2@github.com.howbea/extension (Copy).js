...
class ActivitiesButton extends PanelMenu.Button {
    _init() {
        ...
        let itemws = new PopupMenu.PopupImageMenuItem(_('Workspaces'), 'view-grid-symbolic');
        itemws.connect('activate', () => {
            Main.wm._showWorkspaceSwitcher();
        });
        this.menu.addMenuItem(itemws);
...
class ActivitiesMenuButton extends PanelMenu.Button {
    _init() {
        ...
        const icon = new St.Icon({
            icon_name: 'org.gnome.Settings-search-symbolic',
            style_class: 'activities-icon',
        });
        this._iconBox.set_child(icon);
